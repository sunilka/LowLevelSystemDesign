...
public class GreedyDeliveryStrategy implements DeliveryStrategy {
    ...
    public GreedyDeliveryStrategy(OrderManager orderManager, CustomerManager customerManager,
            RestaurantManager restaurantManager, DeliveryPartnerManager deliveryPartnerManager) {
        ...
        for (int i = 1; i < numberOfOrders; i++) {
            ...
            for (int j = 0; j < numberOfOrders; j++) {
                if (!visited[j]) {
                    ...
                    Restaurant restaurantInfo = this.restaurantManager
                            .getRestaurantByRestaurantID(current.getOrderRestaurantID());
